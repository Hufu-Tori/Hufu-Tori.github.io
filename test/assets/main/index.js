...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './performance-test.ts'], function () {
  return {
    setters: [null, null],
    execute: function () {}
  };
...
System.register("chunks:///_virtual/performance-test.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "9af5e9V+tlBNZr8cL9iv1Ih", "performance-test", undefined);

      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var performance_test = exports('performance_test', (_dec = ccclass('performance_test'), _dec2 = property({
        type: Prefab
      }), _dec3 = property({
        type: Label
      }), _dec4 = property({
        ...
        _inheritsLoose(performance_test, _Component);
        ...
        function performance_test() {
          ...
          _initializerDefineProperty(_this, "button", _descriptor5, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "end", _descriptor6, _assertThisInitialized(_this));
        ...
        var _proto = performance_test.prototype;
        ...
        _proto.createNode = /*#__PURE__*/function () {
          var _createNode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(count) {
            var size, scene, i, vec3, node;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  for (i = 0; i < count; i++) {
                    vec3 = new Vec3(randomRange(0, size.width), randomRange(0, size.height), 0);
                    vec3.set(this.camera.screenToWorld(vec3));
                    vec3.z = 0;
                    node = instantiate(this.model);
                    node.parent = scene;
        ...
        _proto.onTest = function onTest(a) {
        ...
        _proto.onSlider = function onSlider(slider) {
          ...
          this.targetFps = Math.floor(slider.progress * 60);
        ...
        _createClass(performance_test, [{
          ...
          get: function get() {
            var fps = 0;
            this.fpsList.forEach(function (n) {
              fps += 1 / n;
            });
            fps /= this.fpsList.length;
            return fps;
          },
          set: function set(v) {
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "button", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "end", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
